              ...
              <div className="glass p-3 sm:p-4">
                        ...
                        {editing ? (
                          ...
                          <div className="grid grid-cols-[minmax(0,1fr)_4.25rem_5.25rem_4rem_5.25rem_4.5rem] items-center gap-1.5 sm:grid-cols-[minmax(0,1fr)_5rem_6rem_4.5rem_6rem_5rem] sm:gap-2">
                            ...
                            <div className="flex items-center justify-end gap-0.5">
                              ...
                              <button type="button" onClick={async () => { await deleteLoot(l.id); if (selectedId) setLoots(sortLootsByRarity(await listLoots(selectedId))); }} className="flex size-8 items-center justify-center rounded text-muted-foreground hover:text-rose-400">
                ...
                {loots.length > 0 && (
                  <button
                    ...
                    className="btn-ghost mt-3 flex h-11 w-full items-center justify-center gap-2 text-sm"
                  >
